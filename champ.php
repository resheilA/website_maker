...
<div class="page-content container note-has-grid" style="width:100%;">
    ...
    <div class="tab-content bg-transparent">
        <div id="note-full-container" class="note-has-grid row">
            <div class="col-md-12 all-category" style="width:100%;">
                <div class="card card-body">                    
                    <h5 class="note-title text-truncate w-75 mb-0" data-noteheading="Book a Ticket for Movie"> Add a Post</h5>                    
                    <div class="note-content">
						<input type="text" class="form-control mt-3" placeholder="Title">
                       <textarea class="form-control mt-3" placeholder="Enter your thoughts"></textarea>
...
<div class="tab-content bg-transparent">
        <div id="note-full-container" class="note-has-grid row">
            <div class="col-md-12 all-category" style="">
                <div class="card card-body">
                    <span class="side-stick"></span>
					...
					<div class="media border p-3">
					  ...
					  <div class="media-body"><h6>Add a comment</h6>
						<input type="text" class="form-control"><input type="submit" class="btn btn-primary">
					  </div>
					</div>
...
<div class="tab-content bg-transparent">
        <div id="note-full-container" class="note-has-grid row">
            <div class="col-sm-12 all-category" style="">
                <div class="card card-body">
                    <span class="side-stick"></span>
                    <h5 class="note-title text-truncate w-75 mb-0" data-noteheading="Book a Ticket for Movie">Book a Ticket for Movie <i class="point fa fa-circle ml-1 font-10"></i></h5>
                    <p class="note-date font-12 text-muted">11 March 2009</p>
